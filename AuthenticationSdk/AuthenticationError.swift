...
public enum AuthenticationError: Error, LocalizedError {
    ...
    public var recoverySuggestion: String? {
        ...
        case .noProviderAvailable:
            return "Please ensure at least one supported 3DS SDK framework (Netcetera, Cardinal, Trident) is included in your project."
        case .preferredProviderUnavailable:
            return "Try using a different provider or let the SDK auto-select by not specifying a preference."
        case .sessionNotInitialized:
            return "Call initThreeDsSession before creating transactions."
        default:
            return nil
        }
    }
